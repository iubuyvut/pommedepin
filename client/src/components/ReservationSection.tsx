    ...
    <section id="reservation" className="relative py-24 md:py-32">
      ...
      <div ref={ref} className="container">
        ...
        >
          ...
          >
            Réservez votre <span className="text-accent italic">table</span>
          </h2>
          <p
                ...
                return (
                  <div
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors ${
                      isActive
                        ? "text-accent border-b-2 border-primary bg-primary/5"
                        : isDone
                        ? "text-accent/60"
                        : "text-foreground/30"
                    }`}
          ...
          <div className="p-6 md:p-8">
            <AnimatePresence mode="wait">
              ...
              {submitted && (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-accent font-medium">{form.guests} personne{form.guests > 1 ? "s" : ""}</span> est
                    réservée le :
                  </p>
                  <p
                    className="text-accent text-xl font-semibold mb-1"
                    style={{ fontFamily: "'Outfit', sans-serif" }}
                  >
                    {selectedDateStr}
                  </p>
                  <p
                    className="text-accent/80 text-lg mb-8"
                    style={{ fontFamily: "'Outfit', sans-serif" }}
                  >
                    à {form.time}
                  </p>
                  ...
                  <button
                    onClick={handleReset}
                    className="px-8 py-3 border border-primary/40 text-accent rounded-full text-sm font-medium hover:bg-primary/10 transition-all"
                    style={{ fontFamily: "'Outfit', sans-serif" }}
                  >
                  ...
                  <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={prevMonth}
                          className="w-8 h-8 rounded-lg bg-card border border-border/30 flex items-center justify-center text-foreground/60 hover:text-accent hover:border-primary/30 transition-all"
                        >
                        ...
                        return (
                          <button
                            ...
                            className={`relative h-10 rounded-lg text-sm font-medium transition-all ${
                              selected
                                ? "bg-primary text-background shadow-[0_0_12px_rgba(201,169,110,0.3)]"
                                : disabled
                                ? "text-foreground/15 cursor-not-allowed"
                                : todayMark
                                ? "bg-primary/10 text-accent border border-primary/30 hover:bg-primary/20"
                    ...
                    <div className="flex items-center gap-4 mt-3 text-xs text-foreground/30" style={{ fontFamily: "'Outfit', sans-serif" }}>
                      ...
                      <span className="flex items-center gap-1">
                        <span className="w-2 h-2 rounded-full bg-primary/40" /> Aujourd'hui
                      </span>
                    </div>
                        ...
                        {timeSlots.map((slot) => (
                          <button
                            ...
                            className={`py-2.5 rounded-lg text-sm font-medium transition-all ${
                              form.time === slot
                                ? "bg-primary text-background shadow-[0_0_12px_rgba(201,169,110,0.3)]"
                                : "bg-card/50 border border-border/20 text-foreground/60 hover:border-primary/30 hover:text-foreground"
                            }`}
                            style={{ fontFamily: "'Outfit', sans-serif" }}
                          >
                            {slot}
              ...
              {!submitted && step === "details" && (
                ...
                >
                  {/* Summary pill */}
                  <div className="flex flex-wrap items-center gap-3 mb-8 p-4 rounded-xl bg-primary/5 border border-primary/20">
                    <span className="flex items-center gap-1.5 text-sm text-accent" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    ...
                    <button
                      onClick={handleBack}
                      className="ml-auto text-foreground/40 hover:text-accent transition-colors"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <label className="text-foreground/60 text-sm mb-2 flex items-center gap-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        <User className="w-4 h-4 text-accent/60" /> Nom complet *
                      </label>
                      <input
                        type="text"
                        value={form.name}
                    ...
                    <div>
                      <label className="text-foreground/60 text-sm mb-2 flex items-center gap-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        <Phone className="w-4 h-4 text-accent/60" /> Téléphone *
                      </label>
                      <input
                        type="tel"
                        value={form.phone}
                    ...
                    <div>
                      <label className="text-foreground/60 text-sm mb-2 flex items-center gap-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        <Mail className="w-4 h-4 text-accent/60" /> Email (optionnel)
                      </label>
                      <input
                        type="email"
                        value={form.email}
                    ...
                    <div>
                      <label className="text-foreground/60 text-sm mb-2 flex items-center gap-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        <MessageSquare className="w-4 h-4 text-accent/60" /> Remarques (optionnel)
                      </label>
                      <textarea
                        value={form.notes}
                  ...
                  <div className="flex gap-3 mt-8">
                    <button
                      onClick={handleBack}
                      className="flex-1 py-4 border border-border/30 text-foreground/60 rounded-xl text-base font-medium hover:border-primary/30 hover:text-foreground transition-all"
                      style={{ fontFamily: "'Outfit', sans-serif" }}
                    >
                      Retour
                    </button>
                    <button
                      onClick={handleNext}
                      className="flex-[2] py-4 bg-primary text-background rounded-xl text-base font-semibold hover:bg-primary-light transition-all duration-300 hover:shadow-[0_0_20px_rgba(201,169,110,0.3)]"
                      style={{ fontFamily: "'Outfit', sans-serif" }}
                    >
        ...
        >
          ...
          <span className="text-accent">02 374 27 36</span>.
        </motion.p>
      </div>
    </section>
  );
