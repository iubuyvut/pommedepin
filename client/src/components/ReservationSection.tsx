    ...
    <section id="reservation" className="relative py-24 md:py-32">
      ...
      <div ref={ref} className="container">
        ...
        <motion.div
          ...
          className="max-w-3xl mx-auto rounded-2xl bg-card/60 border border-[#f7e7ce]/40 backdrop-blur-sm overflow-hidden"
        >
          {/* Progress Bar */}
          {!submitted && (
                  ...
                  <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={prevMonth}
                          className="w-8 h-8 rounded-lg bg-card border border-[#f7e7ce]/40 flex items-center justify-center text-foreground hover:text-gold hover:border-gold/30 transition-all"
                        >
                          ...
                          <button
                            ...
                            className={`relative h-10 rounded-lg text-sm font-medium transition-all ${
                              selected
                                ...
                                : "text-foreground hover:bg-card hover:text-foreground border border-transparent hover:border-[#f7e7ce]/40"
                            }`}
                            style={{ fontFamily: "'Outfit', sans-serif" }}
                          >
                            {date.getDate()}
                        ...
                        {timeSlots.map((slot) => (
                          <button
                            ...
                            className={`py-2.5 rounded-lg text-sm font-medium transition-all ${
                              form.time === slot
                                ? "bg-gold text-background shadow-[0_0_12px_rgba(201,169,110,0.3)]"
                                : "bg-[#f7e7ce]/20 border border-border/20 text-foreground hover:border-gold/30 hover:text-foreground"
                            }`}
                            style={{ fontFamily: "'Outfit', sans-serif" }}
                          >
                            {slot}
              ...
              {!submitted && step === "details" && (
                ...
                >
                  ...
                  <div className="flex gap-3 mt-8">
                    <button
                      onClick={handleBack}
                      className="flex-1 py-4 border border-[#f7e7ce]/40 text-foreground rounded-xl text-base font-medium hover:border-gold/30 hover:text-foreground transition-all"
                      style={{ fontFamily: "'Outfit', sans-serif" }}
                    >
                      Retour
                    </button>
