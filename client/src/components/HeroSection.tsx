...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative h-screen min-h-[700px] overflow-hidden bg-background">
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col justify-center container">
        <div className="max-w-3xl">
          ...
          >
            <div className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-transparent border border-foreground">
              <Star className="w-4 h-4 text-accent fill-accent" />
              <span className="text-foreground text-sm font-medium" style={{ fontFamily: "'Outfit', sans-serif" }}>
                4,4
              </span>
              <span className="text-foreground text-sm" style={{ fontFamily: "'Outfit', sans-serif" }}>
                — 247 avis
              </span>
            </div>
            <span className="text-foreground text-sm" style={{ fontFamily: "'Outfit', sans-serif" }}>
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.95] mb-6 text-foreground"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            L'art de la
            <br />
            <span className="text-accent italic">pizza</span> depuis
            <br />
            plus de 20 ans
          </motion.h1>
